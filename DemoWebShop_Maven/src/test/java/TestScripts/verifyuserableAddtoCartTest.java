...
public class verifyuserableAddtoCartTest extends BaseTest1{
	public commonUtility common_Utility=new commonUtility();
	@Test
	public void WishlistTestcase() throws InterruptedException, FileNotFoundException {
		//LaunchBrowser();
		//Login();
		// step1:Open Browser
...
//		}
		...
		//use after reporter log
		test.log(Status.INFO,"demo web shop  page is displayed");
		test.addScreenCaptureFromPath(common_Utility.toTakescreenshort(driver),"demo web shop  page is displayed");
	}
}
